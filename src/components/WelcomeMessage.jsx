...
const WelcomeMessage = () => {
    return (
        <div className="bg-blue-900 flex gap-14 py-12 px-10">
            ...
            <div className="flex-1 bg-blue-300 border-[1px] border-yellow-400 rounded-lg p-6">
                <div className="mb-6">
                ...
                <div>
                    <div className="flex justify-between">
                        <div className="flex-1 border-t-[1px] border-r-[1px] border-white pt-6 pr-6">
                        ...
                        <div className="flex-1 border-t-[1px] border-white pt-6 pl-6">
