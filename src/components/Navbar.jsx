...
const Navbar = () => {
  ...
  return (
    <div className='bg-[#002643] pt-4'>
      ...
      {/* middle part */}
      <div className='flex justify-between items-center pl-8 pr-20 pb-4 pt-2'>
        <div className='uppercase flex justify-center items-center pt-2'>
          <div className=''>
